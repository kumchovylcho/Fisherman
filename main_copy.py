...
while running:
    ...
    fish_hitbox_draw = pygame.draw.rect(screen, (0, 0, 0), (fish_hitbox.x, fish_hitbox.y, 130, 75), 2)
    hook_hitbox.x, hook_hitbox.y = fisherman_line.tip_of_the_rod - 10, hook.y_pos
    hook_hitbox_draw = pygame.draw.rect(screen, (0, 0, 0), (hook_hitbox.x, hook_hitbox.y, 17, 33), 2)
